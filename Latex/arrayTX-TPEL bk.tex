...
\soulregister\eqref7 % 针对\citep命令
...
\begin{document}
\title{
%A Planar Extendable Multi-coil Transmitter Architecture for Wireless Power Transfer with Six Degrees of Receiver Freedom
%A Planar Extendable Multi-coil Transmitter Architecture for Six Degrees of Freedom Wireless Power Transfer: Layout, Modeling, Design, Analysis, and Implementation
%A Planar and Linear-Extendable Multi-coil Transmitter Architecture for Six Degrees of Freedom Wireless Charging Applications
...
\thanks{N.~Kang, Y.~Shao, and C.~Ma are with University of Michigan-Shanghai Jiaotong University Joint Institute, Shanghai Jiao Tong University, Shanghai 200240, P. R. China (e-mail: chbma@sjtu.edu.cn); M. Liu is with the Key Laboratory of Control of Power Transmission and Conversion of Ministry of Education, and the School of Electronic Information and Electrical	Engineering, Shanghai Jiao Tong University, Shanghai 200240, China.}
}
...
%\markboth{IEEE TRANSACTIONS ON POWER ELECTRONICS}%
...
\begin{figure}[ht!]
    \centering
    \centerline{\includegraphics[width=8cm]{fig/fig1.eps}}
...
\begin{figure*}[ht!]
    ...
    \caption{Calculation results of B-field ADFs generated by by a 2$\times$2 planar Tx-coil array~($x$=8.2~cm). (a) Layout and coordinates for Fig.~\ref{b1} and Fig.~\ref{b2}. (b) $\theta_1 = 0 {}^{\circ}$, $\theta_2 = 0 {}^{\circ}$, $\theta_3 = 0 {}^{\circ}$, and $\theta_4 = 0 {}^{\circ}$. (c) $\theta_1 = 0 {}^{\circ}$, $\theta_2 = 0 {}^{\circ}$, $\theta_3 = 180 {}^{\circ}$, and $\theta_4 = 180 {}^{\circ}$. (d) Layout and coordinates for Fig.~\ref{z1} and Fig.~\ref{z2}. (e) $\theta_1 = 0 {}^{\circ}$, $\theta_2 = 0 {}^{\circ}$, $\theta_3 = 0 {}^{\circ}$, and $\theta_4 = 0 {}^{\circ}$. (f) $\theta_1 = 0 {}^{\circ}$, $\theta_2 = 0 {}^{\circ}$, $\theta_3 = 180 {}^{\circ}$, and $\theta_4 = 0 {}^{\circ}$.}
    \label{3deg2}
\end{figure*}
...
Coil array area (cm$^2$)  & 20.0$\times$20.0  & 20.0$\times$20.0   & 17.8$\times$17.8  \\   % 17.76
...
\begin{figure}[ht!]
    \centering
    \centerline{\includegraphics[width=8.0cm]{fig/fig13.eps}}
